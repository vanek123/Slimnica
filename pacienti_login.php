...
<head>
    ...
    <link rel="stylesheet" href="pacienti_login.css">
        ...
        <div class="forms">
            ...
            <div class="form signup">
                ...
                <form action="#">
                    ...
                    <div class="input-field">
                        <input type="text" placeholder="Enter your personal code" required>
                        <i class="uil uil-user"></i>
                    </div>
                    <div class="input-field">
                    ...
                    <div class="input-field">
                        <select class="select" placeholder="Choose your gender"  required>
